...
$modules = [
    ...
    'DismaxMunge', 'FacetPrefix', 'ExtendedFeedback', 'LuceneHelper', 'RecordDriver', 'SearchKeys', 'DependentWorks', 'Libraries', 'Delivery', 'ExtendedFacets', 'DAIAplus', 'PAIAplus', 'BelugaConfig',
];
