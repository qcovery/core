$(document).ready(function() {
	$('.daia-availability').each(function(){
		var $this = $(this);
        $.ajax({
			url:'/vufind/PAIA/availability?ppn='+jQuery(this).attr('data-ppn')+'&daia='+jQuery(this).data('daia')+'&marcField951aValue='+jQuery(this).attr('data-marcField951aValue')+'&list='+jQuery(this).data('list')+'&mediatype='+jQuery(this).data('mediatype'),
