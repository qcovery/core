...
class Options extends \VuFind\Search\Base\Options
{
    ...
    public function __construct(\VuFind\Config\PluginManager $configLoader)
    {
        ...
        $this->searchIni = $this->facetsIni = 'Findex';
    ...
    {
        return 'findex-advanced';
    }

    /**
     * Basic 'getter' for Findex advanced search operators.
     *
     * @return array
     */
