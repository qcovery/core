...
class Params extends \VuFind\Search\Base\Params
{
    ...
    {
        $this->initFacetList('Facets', 'Results_Settings', 'Findex');
        $this->initFacetList('Advanced_Facets', 'Advanced_Facet_Settings', 'Findex');
        $this->initCheckboxFacets('CheckboxFacets', 'Findex');
    }
}
