 ...
 */
namespace RelevancePicker\Search\Results;
...
//        $paramsService = preg_replace('/^VuFind/', 'RelevancePicker', $paramsService);
        $params = $container->get('RelevancePicker\Search\Params\PluginManager')
            ->get($paramsService);
